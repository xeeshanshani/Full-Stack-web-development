...
export class News extends Component {
  ...
  async componentDidMount() {
    let url = "https://newsapi.org/v2/top-headlines?country=us&apiKey=a4665c8315b549e0b09c5bf02715c77d";
  ...
  prevPg = async () => {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=a4665c8315b549e0b09c5bf02715c77d&page=${this.state.page - 1}&pageSize=12`;
