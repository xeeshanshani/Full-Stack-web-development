      ...
      <div>
        <Router>
          ...
          <Switch>
            ...
            <Route exact path="/entertainment"><News country="us" pageSize={12} category="entertainment"
            ...
            <Route exact path="/technology"><News country="us" pageSize={12} category="technology" key="technology" />
            </Route>
